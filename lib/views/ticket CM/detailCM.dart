...
import 'package:flutter_application_1/views/ticket%20CM/updateCM.dart';
...
class DetailPageCM extends StatelessWidget {
  @override
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => UpdatePageCM()));
