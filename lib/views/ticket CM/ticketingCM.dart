...
import 'package:flutter_application_1/views/ticket%20CM/createCM.dart';
import 'package:flutter_application_1/views/ticket%20CM/detailCM.dart';
import 'package:flutter_application_1/views/utils.dart';

class TicketingCMPage extends StatelessWidget {
  const TicketingCMPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('Ticketing CM', style: MyTextStyles.style17),
      ),
      body: Stack(
        children: [
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => CreatePageCM()),
                );
              },
              child: Container(
                width: 80,
              ...
              child: DataTable(
                ...
                rows: [
                  ...
                  DataRow(cells: [
                    ...
                    DataCell(Center(child: Text('Procash'))),
                    DataCell(Center(child: Text('Serial Number'))),
                    DataCell(Center(child: Text('Open'))),
                    DataCell(
                      Center(
                        child: ListTile(
                          leading: Icon(Icons.info),
