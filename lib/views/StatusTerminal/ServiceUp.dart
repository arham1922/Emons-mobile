...
class ServiceUpPage extends StatelessWidget {
   ServiceUpPage({Key? key});

  Future<List<Map<String, dynamic>>?> fetchData() async {
    try {
      final response =
          await http.get(Uri.parse('http://10.10.7.9:8083/emon-ws/emonmbl/termstatus?status=3'));
              ...
              children: [
                ...
                const Center(
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: 90),
                      Text('Service Up', style: MyTextStyles.style8),
                    ],
                  ),
                ),
                Positioned(
