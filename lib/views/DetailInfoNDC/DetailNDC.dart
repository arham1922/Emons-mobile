...
import 'package:flutter_application_1/views/DetailInfoNDC/CounterStatus.dart';
import 'package:flutter_application_1/views/DetailInfoNDC/HardwareStatus.dart';
import 'package:flutter_application_1/views/DetailInfoNDC/SupplayStatus.dart';
import 'package:flutter_application_1/views/utils.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;

// ignore: must_be_immutable
class DetailNDC extends StatelessWidget {
  final String atmid;
  ...
  DetailNDC({Key? key, required this.atmid}) : super(key: key);
        ...
        children: [
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                button(width: 70, height: 38, onTap: () {Navigator.of(context).push(MaterialPageRoute(builder: (context) => SupplayStatus (atmid: atmid,),));},
                child: Text('Supplay Status',textAlign: TextAlign.center ,style:MyTextStyles.style7,),),
                button(width: 70, height: 38, onTap: () { Navigator.of(context).push(MaterialPageRoute(builder: (context) =>  HardwareStatus(atmid: atmid,),)); },
                child: Text('Hardware Status',textAlign: TextAlign.center ,style:MyTextStyles.style7,),),
                button(width: 70, height: 38, onTap: () {Navigator.of(context).push(MaterialPageRoute(builder: (context) =>  CounterStatus(atmid: atmid,),));},
                child: Text('Counter Status',textAlign: TextAlign.center ,style:MyTextStyles.style7,),),
                button(width: 70, height: 38, onTap: () { Navigator.of(context).push(MaterialPageRoute(builder: (context) => DaftarTransaksiDDC(),)); },
